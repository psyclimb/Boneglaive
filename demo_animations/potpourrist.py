    ...
    def draw(self, surface):
        ...
        if self.phase == "swing" or self.phase == "impact":
            if self.swing_progress > 0:
                ...
                # The line sweeps 180 degrees like a clock hand
                if self.swing_direction == "north":
                    start_angle = math.pi  # West
                    end_angle = 0  # East
                elif self.swing_direction == "south":
                    start_angle = 0  # East
                    end_angle = math.pi  # West
                elif self.swing_direction == "west":
                    start_angle = -math.pi / 2  # North
                    end_angle = math.pi / 2  # South
                else:  # east
                    start_angle = math.pi / 2  # South
                    end_angle = -math.pi / 2  # North
                    ...
                    if fade > 0.01:
                        ...
                        if self.infused:
                            ...
                            for sample in range(8):
                                ...
                                # Outer purple glow - stretched ellipse
                                ...
                                if alpha > 0:
                                    ...
                                    pygame.draw.ellipse(blur_surf, (200, 100, 255, alpha), (0, 0, blur_w, blur_h))
                                ...
                                if alpha > 0:
                                    ...
                                    blur_surf = pygame.Surface((blur_w, blur_h), pygame.SRCALPHA)
                                    pygame.draw.ellipse(blur_surf, (255, 215, 0, alpha), (0, 0, blur_w, blur_h))

                                    rotated = pygame.transform.rotate(blur_surf, math.degrees(-angle + math.pi/2))
                                    rect = rotated.get_rect(center=(int(px), int(py)))
                                    surface.blit(rotated, rect)

                                # Particle streaks - emit perpendicular to swing direction
                                if sample_t > 0.3 and random.random() < 0.15 * speed * fade:
                                    ...
                                    if spark_alpha > 0:
                                        ...
                                        pygame.draw.circle(spark_surf, (255, 180, 200, spark_alpha), (4, 4), 4)
                ...
                if self.infused:
                    ...
                    for sample in range(8):
                        ...
                        # Outer purple glow (brightest) - stretched
