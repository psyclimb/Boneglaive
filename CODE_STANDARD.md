...
- Graphical layer (`boneglaive/graphical/`) never imports from `boneglaive/ui/` (curses layer)
- Text UI (`boneglaive/ui/`) never imports from `boneglaive/graphical/`
- Both renderers interact with the game through `MultiplayerManager` for turn flow
