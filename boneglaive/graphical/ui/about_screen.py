...
class AboutScreen:
    ...
    def draw(self, surface: pygame.Surface):
        ...
        lines = [
            ...
            ("Source code: GNU GPL v3.0 — see LICENSE for full terms.", self.font, (100, 200, 255), 1.2),
            ("Game assets copyright (C) 2026 Psyclimb. All rights reserved.", self.font, (100, 200, 255), 1.2),
            ("This program comes with ABSOLUTELY NO WARRANTY.", self.font, COLOR_TEXT, 2.0),
            ("You are welcome to redistribute the source under certain conditions.", self.font, COLOR_TEXT, 1.0),
            ("See LICENSE and ASSETS_LICENSE.md for full terms.", self.font, COLOR_TEXT, 2.0),
