            ...
            'skills': [
                ...
                },
                {
                    ...
                    'details': [
                        ...
                        'Requires line of sight to a unit / furniture / solid terrain anchor',
                        'Same arrival slam as Skyhook (shares Crash Landing); refunds 2 cooldown per stack detonated'
                    ]
                },
                {
                    'name': 'HARVEST (Active)',
